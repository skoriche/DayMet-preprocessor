...
<qgis version="3.34.7-Prizren">
  <identifier>GSLSubbasins</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>GSLSubbasins</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Personal GeoDatabase Feature Class" url="file://\\EAGLE\C$\Ibrahim\GSL\GSL_basins.mdb" type="Local Area Network" description="" size="" format="" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
